...
public class TestOneLevelMatcher extends CommonMatcherTest {
	...
	private OneLevelMatcher<IndexedValue, Wildcard<IndexedValue>, IndexedValue> matcher() {
		// direct matching
		return new OneLevelMatcher<IndexedValue, Wildcard<IndexedValue>, IndexedValue>(
				new NodeMatch<IndexedValue, Wildcard<IndexedValue>, IndexedValue>() {
					...
					@Override
					public IndexedValue buildResult(Wildcard<IndexedValue> wildcard, IndexedValue node) {
						return node;
					}
				});
	}
	...
	public void testSimpleMatch() {
		OneLevelMatcher<IndexedValue, Wildcard<IndexedValue>, IndexedValue> matcher = matcher();
